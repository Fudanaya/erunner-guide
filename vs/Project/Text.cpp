...
Engine::Text* Engine::Text::CenterTextX()
{
	...
	for (c = text.begin(); c != text.end(); c++)
	{
		...
		totalWidth += (ch.Advance >> 6) * scale; // Advance stores width in 1/64 pixels
	}
...
Engine::Text* Engine::Text::CenterTextY()
{
	// Use the height of the 'H' character as a baseline (usually the tallest glyph)
	float maxHeight = TextCharacters['H'].Size.y * scale;
